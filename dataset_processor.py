...
class Sst2Processor(DataProcessor):
    ...
    # def get_train_examples(self, tensor_dict):
    #     """See base class."""
    #     return self._create_examples(tensor_dict, "train")

    # def get_dev_examples(self, tensor_dict):
    #     """See base class."""
    #     return self._create_examples(tensor_dict, "validation")

    # def get_test_examples(self, tensor_dict):
    #     """See base class."""
    #     return self._create_examples(tensor_dict, "test")
    ...
    def _create_examples(self, dataset):  # , set_type
        """Creates examples for the training, dev and test sets."""
        # dataset_set = dataset[set_type]
        examples = {}
        text_index = 0

        for (i, line) in enumerate(list(dataset.keys())[0]):
            examples['sentence'] = line['sentence']
            examples['label'] = line['label']
            # examples.append(InputExample(guid=guid, text_a=text_a, text_b=None, label=label))
        return examples
