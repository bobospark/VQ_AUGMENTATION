...
def greedy_search(greedy_or_not, args, model_name, model):
    ...
    if model_name == 'Finetuning_RoBERTa':
        seeds = [13,42, 100]  #,           21, 87, 
        datasets = ['qqp' ,'mnli', 'mnli-mm',]  #       코드 수정 필요 # finished 'sst-2', 'cola', 'mrpc', 'qnli', 'rte', 'wnli',
